...
export default function Pricing() {
  ...
  const plans = [
    {
      ...
      monthlyPrice: 7,
      yearlyPrice: 69,
      description: "Create 50 AI interior Design renders per month",
      features: [
        "Create 50 renders/mo",
        "25+ Room types",
    ...
    },
    {
      ...
      monthlyPrice: 29,
      yearlyPrice: 290,
      description: "Create 300 Al Interior Design renders per month",
      features: [
        "Everything in pro plan",
        "Create 300 renders/mo",
    ...
    },
    {
      title: "Enterprise",
      price: "199",
      description: "Create 5,000 renders per month",
      features: [
        "Everything in Premium plan",
        "Create 25,000 renders/mo",
        "Early access to new features",
      ],
      actionLabel: "Subscribe",
      exclusive: true,
  ...
  return (
    <div className="py-8 mt-24" id="pricing">
      <PricingHeader
        title="Pricing Plans"
        subtitle=" Get your dream room ready within seconds!"
      />
